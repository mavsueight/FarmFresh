// src/components/ProductPages/ApplePage.js
import React from 'react';
import './ApplePage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Apple</h2>
            <p>₱80 / kg</p>
            <p>Fresh, crisp, and sweet apples straight from the farm. Perfect for snacking or adding to your favorite dishes.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Apple', '₱80')}
            >
              Add to Cart
            </button>
          </div>
