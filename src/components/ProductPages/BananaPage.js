// src/components/ProductPages/BananaPage.js
import React from 'react';
import './BananaPage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Banana</h2>
            <p>₱50 / kg</p>
            <p>Sweet, ripe bananas perfect for breakfast or adding to your smoothies. A healthy and delicious choice.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Banana', '₱50')}
            >
              Add to Cart
            </button>
          </div>
