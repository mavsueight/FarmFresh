// src/components/ProductPages/BroccoliPage.js
import React from 'react';
import './BroccoliPage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Broccoli</h2>
            <p>₱50 / bunch</p>
            <p>Fresh and nutrient-packed broccoli, perfect for steaming, roasting, or adding to your favorite meals.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Broccoli', '₱50')}
            >
              Add to Cart
            </button>
          </div>
