// src/components/ProductPages/CheesePage.js
import React from 'react';
import './CheesePage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Cheese</h2>
            <p>₱250 / pack</p>
            <p>Delicious, creamy cheese perfect for sandwiches, pasta, or just enjoying on its own. A must-have for cheese lovers!</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Cheese', '₱250')}
            >
              Add to Cart
            </button>
          </div>
