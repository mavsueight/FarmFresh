// src/components/ProductPages/CroissantPage.js
import React from 'react';
import './CroissantPage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Croissant</h2>
            <p>₱35 / piece</p>
            <p>Flaky, buttery croissants baked fresh daily, perfect for breakfast or a delicious snack.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Croissant', '₱35')}
            >
              Add to Cart
            </button>
          </div>
