// src/components/ProductPages/GrapesPage.js
import React from 'react';
import './GrapesPage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Grapes</h2>
            <p>₱140 / kg</p>
            <p>Sweet and juicy grapes, perfect for snacking or adding to your favorite fruit salads.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Grapes', '₱140')}
            >
              Add to Cart
            </button>
          </div>
