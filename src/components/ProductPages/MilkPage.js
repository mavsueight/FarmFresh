// src/components/ProductPages/MilkPage.js
import React from 'react';
import './MilkPage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Milk</h2>
            <p>₱55 / liter</p>
            <p>Fresh, wholesome milk from local farms. Great for your daily cereal or making delicious milkshakes.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Milk', '₱55')}
            >
              Add to Cart
            </button>
          </div>
