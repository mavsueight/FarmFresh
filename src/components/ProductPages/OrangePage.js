// src/components/ProductPages/OrangePage.js
import React from 'react';
import './OrangePage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            ...
            <h2>Orange</h2>
            <p>₱90 / kg</p>
            <p>Fresh and juicy oranges packed with vitamin C. Great for juicing or eating on the go.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Orange', '₱90')}
            >
              Add to Cart
            </button>
          </div>
