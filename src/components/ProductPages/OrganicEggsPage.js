// src/components/ProductPages/OrganicEggsPage.js
import React from 'react';
import './OrganicEggsPage.css'; // Ensure to import your CSS file
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            <img src="images/eggs.jpg" alt="Organic Eggs" />
            <h2>Organic Eggs</h2>
            <p>₱120 / dozen</p>
            <p>Fresh, organic eggs from local farms, perfect for breakfast or adding to your favorite recipes.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Organic Eggs', '₱120')}
            >
              Add to Cart
            </button>
          </div>
