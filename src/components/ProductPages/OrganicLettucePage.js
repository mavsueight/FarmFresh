// src/components/ProductPages/OrganicLettucePage.js
import React from 'react';
import './OrganicLettucePage.css'; // Ensure to import your CSS file

const OrganicLettucePage = () => {
      ...
      <main>
        <section className="product-details">
          <div className="product-info">
            <img src="images/lettuce.jpg" alt="Organic Lettuce" />
            <h2>Organic Lettuce</h2>
            <p>₱70 / bunch</p>
            <p>Fresh, organic lettuce perfect for making healthy salads, wraps, or topping sandwiches.</p>
            <button
              className="add-to-cart"
              onClick={() => addToCart('Organic Lettuce', '₱70')}
            >
              Add to Cart
            </button>
          </div>
...
export default OrganicLettucePage;
